"""Behavior tests for agents/task_teacher_v16/main.py.
"""
...
V16_CONFIG = {"episodeSteps": 720, "turnsPerDay": 24, "farmHandCostMult": 10}
...
def test_caps_v16():
    module = load_agent_module("task_teacher_v16")
...
def test_goose_buy_and_egg_sell():
    ...
    action = module.agent(obs, V16_CONFIG)
...
def test_simulator_full_episode_v16():
    module = load_agent_module("task_teacher_v16")
