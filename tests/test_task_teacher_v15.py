"""Behavior tests for agents/task_teacher_v15/main.py.
"""
...
def test_caps_v15():
    module = load_agent_module("task_teacher_v15")
...
def test_goose_buy_and_egg_sell():
    ...
    action = module.agent(obs, V15_CONFIG)
...
def test_simulator_full_episode_v15():
    module = load_agent_module("task_teacher_v15")
