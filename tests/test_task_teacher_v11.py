"""Behavior tests for agents/task_teacher_v11/main.py.
"""
...
BOARD_SIZE = 10
V11_CONFIG = {"episodeSteps": 720, "turnsPerDay": 24}
...
def test_caps_v11():
    module = load_agent_module("task_teacher_v11")
...
def test_protects_nw_crop_pasture_build():
    ...
    action = module.agent(obs, V11_CONFIG)
    pass
...
def test_simulator_full_episode_v11():
    module = load_agent_module("task_teacher_v11")
