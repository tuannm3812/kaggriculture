"""Behavior tests for agents/task_teacher_v14/main.py.
"""
...
V14_CONFIG = {"episodeSteps": 720, "turnsPerDay": 24, "farmHandCostMult": 10}
...
def test_caps_v14():
    module = load_agent_module("task_teacher_v14")
...
def test_goose_buy_and_egg_sell():
    ...
    action = module.agent(obs, V14_CONFIG)
...
def test_simulator_full_episode_v14():
    module = load_agent_module("task_teacher_v14")
