"""Behavior tests for agents/task_teacher_v17/main.py.
"""
...
V17_CONFIG = {"episodeSteps": 720, "turnsPerDay": 24, "farmHandCostMult": 10}
...
def test_caps_v17():
    module = load_agent_module("task_teacher_v17")
...
def test_goose_buy_and_egg_sell():
    ...
    obs = make_obs(
        day=15,
        hour=0,
        money=2000.0,  # Cash = 2000.0, which is >= 300 + 1200 = 1500. Should buy!
        farmer=(4, 4),
        tiles=tiles,
        shed={"EGG": 5, "FERTILIZER": 10},
        unlocked_quadrants=["NW", "NE"],
    )
    action = module.agent(obs, V17_CONFIG)
...
def test_simulator_full_episode_v17():
    module = load_agent_module("task_teacher_v17")
